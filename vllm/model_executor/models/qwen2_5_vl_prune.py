...
The current implementation includes VisionZip and CDPruner.
...
from .qwen2_5_vl_cdpruner import (
    apply_qwen2_5_cdpruner as apply_qwen2_5_cdpruner_impl,
)
...
def get_qwen2_5_vision_zip_num_tokens(
    ...
    return get_qwen2_5_pruned_num_tokens(num_tokens, mm_config)


def get_qwen2_5_cdpruner_num_tokens(
    num_tokens: int,
    mm_config: _VisualTokenPruneMultiModalConfig | None,
) -> int:
    return get_qwen2_5_pruned_num_tokens(num_tokens, mm_config)
...
def apply_qwen2_5_cdpruner(
    ...
    keep_tokens = get_qwen2_5_cdpruner_num_tokens(
        image_features.shape[0],
        cdpruner_config,
    )
    return apply_qwen2_5_cdpruner_impl(
        image_features,
        positions,
        keep_tokens,
