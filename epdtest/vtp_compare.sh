...
infer_prune_arch_expect_re() {
  ...
  case "$model_lc" in
    *qwen2.5-vl*)
      echo "Qwen2_5_VLPruneForConditionalGeneration|Qwen2_5_VLVisionZipForConditionalGeneration|Qwen2_5_VLDivPruneForConditionalGeneration"
      ;;
    *)
...
validate_method() {
  case "$1" in
    ...
    *)
      ...
      echo "Supported methods: none, visionzip, cdpruner, divprune" >&2
      exit 2
      ;;
  esac
}
